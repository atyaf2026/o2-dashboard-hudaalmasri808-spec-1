...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en">
      ...
      <body className="bg-[#f8fafc] flex h-screen overflow-hidden font-['Plus_Jakarta_Sans',sans-serif] text-[#1e293b]">
        
        {/* SIDEBAR */}
        <aside className="w-[280px] bg-white border-r border-slate-100 flex flex-col h-full shrink-0">
          ...
          <div className="p-6 border-t border-slate-100 space-y-2">
            ...
            <div className="flex items-center gap-3 px-2 mb-4 cursor-pointer hover:bg-slate-50 p-2 rounded-xl transition-all">
              <div className="w-9 h-9 rounded-full bg-[#4f46e5] flex items-center justify-center text-white font-bold text-xs">
                MA
              </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full">
          ...
          {/* HEADER */}
          <header className="h-[72px] bg-white/80 backdrop-blur-md border-b border-slate-100 px-10 flex items-center justify-between">
